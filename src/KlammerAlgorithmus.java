...
/**
 * Ein Algorithmus zum berechnen von Klammerausdruecken
 * 
...
class KlammerAlgorithmus
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		System.out.print("Gib einen algebraischen Ausdruck ein: ");
		String eingabe = br.readLine();
		System.out.println("Ergebnis: " + a.auswerten(eingabe));
	}

	/**
	 * Werte einen algebraischen Ausdruck ohne Berücksichtigung von Punkt- vor
	 * Strichrechnung aus Voraussetzungen: Operationen haben genau 2 Operanden,
	 * Ausdrücke sind vollständig geklammert und Operanden sind Zahlen oder
	 * Klammerausdrücke
	 * 
	 * @param algebraischerAusdruck
	 *            Ein String der aus positiven Zahlen, Klammern und/oder
	 *            Grundoperationen (+-*\/) besteht
	 */
